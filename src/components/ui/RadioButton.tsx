...
export default function RadioButton({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`flex h-5 w-5 items-center justify-center rounded-full border-2 transition-all duration-200 ${checked ? "border-primary" : "border-input"} ${!disabled && "hover:border-primary"} ${disabled ? "cursor-not-allowed" : ""}`}
      >
